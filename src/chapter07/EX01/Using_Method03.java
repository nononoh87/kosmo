...
public class Using_Method03 {
	...
	//static 메소드 내부에 인스턴스 필드나, 메소드를 바로 사용할 수 없다. (객체화 시켜야 사용사능)
		// 
	...
	public static void main(String[] args) {
		...
		*/
		...
		//필드명, 명소드명 앞에 static 키가 적용되어 있으면 객체 생성없이 호출
		//	static 메소드 내에서는 인스턴스 필드나, 인스턴스 메소드를 사용할 수 없다.
		//	static 메소드에서는 static 필드나, static 메소드를 사용할 수 있다.
		
		//c = 5;	//인스턴스 필드	//오류 발생 (static 메소드 내에서 인스턴스 필드 집접 호출(X))
