...
public class Using_Array {
	...
	public static void main(String[] args) {
		...
		// 배열 변수 a를 선언
		int[] a = new int[5]; // a는 참조 변수 (참조 변수값을 가지고 있다.)
		// 배열 a 변수의 방의 크기 5개 생성후 주소값을 a에 할당해라.
		// 방번호 [index] 0~4 방까지 Heap 영역에 생성됨
		// new : Heap 영역에 배열방 5개를 생성해서 Heap 영역의 번지수를 a변수에 할당해라
		...
		// 배열 방의 값을 출력
		System.out.println("==직접 배열방의 값을 출력==");
		...
		// for문을 사용해서 출력
		System.out.println("==for 문을 사용해서 배열방의 값을 출력==");
		for (int i = 0; i < 5; i++) {
			System.out.println(a[i]);
		}

		System.out.println("배열변수 a에 방의 갯수 : " + a.length); // 배열방의 갯수
