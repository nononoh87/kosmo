...
public class Test_A {
	...
	public static void main(String[] args) {
		...
		//객체 생성후 출력 (인스턴스 필드, 정적 필드)
		System.out.println("==객체 생성후 출력==");
		A a1 = new A();
		System.out.println(a1.m); 	//인스턴스 필드 출력 : 객체 생성후 출력
		System.out.println(a1.n); 	//정적 필드 출력 : 객체 생성후, 객체 없이도 출력 
		
		//객체 생성 없이 출력 (클래스 이름.n)
		System.out.println("==객체 생성없이 출력==");
		System.out.println(A.n);	//정적 필드 출력 : 클래스명.n 
		//System.out.println(A.m); 	//인스턴스 필드 : 반드시 객체 생성후 에 객체이름.m
		
		//정적 필드는 모든객체에서 공유하는 필드
