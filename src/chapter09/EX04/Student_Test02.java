...
class Student02 {
	...
	//필드의 접근 제어자 : default로 구성됨 : --외부 클래스에서 객체를 생성후 직접수정이 가능함.
...
class Student03 {
	...
	private static int serialNum = 1000;	//모든 객체에서 공유하는 필드, 객체를 생성할때 마다 1씩 증가
...
public class Student_Test02 {
	...
	public static void main(String[] args) {
		...
		//객체 생성
//		Student03 s3 = new Student("홍길동");
//		s3.serialNum = 2000;		//접근제어자 : private, 접근 불가함
//		s3.studentID = 100;
//		s3.studentName = "홍길동";
